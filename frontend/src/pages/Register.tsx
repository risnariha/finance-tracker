  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-950 px-6 py-10 text-slate-100">
      <div className="w-full max-w-md space-y-6 rounded-[32px] border border-slate-700 bg-slate-900/95 p-8 shadow-soft">
        <div>
          <p className="text-sm uppercase tracking-[0.3em] text-sky-400/80">Create account</p>
          <h1 className="mt-4 text-3xl font-semibold text-white">Start tracking today</h1>
          <p className="mt-3 text-slate-400">Register and gain access to your finance dashboard instantly.</p>
        </div>
        ...
        <p className="text-center text-sm text-slate-400">
          Already registered? <Link className="text-sky-300 hover:text-sky-200" to="/login">Sign in</Link>
        </p>
      </div>
    </div>
  );
